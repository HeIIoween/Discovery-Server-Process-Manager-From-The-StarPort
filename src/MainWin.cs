...
namespace DSProcessManager
{
	...
	public class MainWin : System.Windows.Forms.Form, FLHookListener, LogRecorderInterface
    {
        ...
        /// <summary>
        /// Maximum statistic items to record.
        /// </summary>
        int maxStats = 10000;
        ...
        private DataGridViewTextBoxColumn ColPingFluct;
        private DataGridViewTextBoxColumn ColLoss;
        private DataGridViewTextBoxColumn ColLag;
        private DataGridViewTextBoxColumn ColSaturation;
        private DataGridViewTextBoxColumn ColTxQueue;
		...
		private void InitializeComponent()
		{
            ...
            this.ColPingFluct = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.ColLoss = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.ColLag = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.ColSaturation = new System.Windows.Forms.DataGridViewTextBoxColumn();
            this.ColTxQueue = new System.Windows.Forms.DataGridViewTextBoxColumn();
            ...
            this.tabControl1.Size = new System.Drawing.Size(428, 292);
            ...
            // labelStatusLoad
            // 
            this.labelStatusLoad.Location = new System.Drawing.Point(3, 97);
            this.labelStatusLoad.Name = "labelStatusLoad";
            this.labelStatusLoad.Size = new System.Drawing.Size(50, 26);
            this.labelStatusLoad.TabIndex = 26;
            this.labelStatusLoad.Text = "Load";
            this.labelStatusLoad.TextAlign = System.Drawing.ContentAlignment.TopRight;
            // 
            // pictureBoxPlayers
            // 
            ...
            // labelStatusPlayers
            // 
            this.labelStatusPlayers.Location = new System.Drawing.Point(3, 41);
            this.labelStatusPlayers.Name = "labelStatusPlayers";
            this.labelStatusPlayers.Size = new System.Drawing.Size(50, 26);
            this.labelStatusPlayers.TabIndex = 30;
            this.labelStatusPlayers.Text = "Players";
            this.labelStatusPlayers.TextAlign = System.Drawing.ContentAlignment.TopRight;
            // 
            // labelStatusNPC
            // 
            this.labelStatusNPC.Location = new System.Drawing.Point(3, 153);
            this.labelStatusNPC.Name = "labelStatusNPC";
            this.labelStatusNPC.Size = new System.Drawing.Size(50, 26);
            this.labelStatusNPC.TabIndex = 25;
            this.labelStatusNPC.Text = "NPC";
            this.labelStatusNPC.TextAlign = System.Drawing.ContentAlignment.TopRight;
            // 
            // labelStatusMemory
            // 
            this.labelStatusMemory.Location = new System.Drawing.Point(3, 180);
            this.labelStatusMemory.Name = "labelStatusMemory";
            this.labelStatusMemory.Size = new System.Drawing.Size(50, 26);
            this.labelStatusMemory.TabIndex = 24;
            this.labelStatusMemory.Text = "Mem";
            this.labelStatusMemory.TextAlign = System.Drawing.ContentAlignment.TopRight;
            // 
            // pictureBoxMemory
            // 
            ...
            this.buttonSettings.Location = new System.Drawing.Point(333, 10);
            ...
            // textBoxRestartCount
            // 
            this.textBoxRestartCount.Location = new System.Drawing.Point(221, 12);
            ...
            // textBoxStatus
            // 
            this.textBoxStatus.Location = new System.Drawing.Point(57, 13);
            ...
            this.dataGridViewPlayers.Size = new System.Drawing.Size(408, 225);
            ...
            // ColPingFluct
            // 
            this.ColPingFluct.DataPropertyName = "ColPingFluct";
            this.ColPingFluct.HeaderText = "Ping Fluct";
            this.ColPingFluct.Name = "ColPingFluct";
            this.ColPingFluct.ReadOnly = true;
            this.ColPingFluct.Width = 60;
            // 
            // ColLoss
            // 
            this.ColLoss.DataPropertyName = "ColLoss";
            this.ColLoss.HeaderText = "Loss";
            this.ColLoss.Name = "ColLoss";
            this.ColLoss.ReadOnly = true;
            this.ColLoss.Width = 60;
            // 
            // ColLag
            // 
            this.ColLag.DataPropertyName = "ColLag";
            this.ColLag.HeaderText = "Lag";
            this.ColLag.Name = "ColLag";
            this.ColLag.ReadOnly = true;
            this.ColLag.Width = 60;
            // 
            // ColSaturation
            // 
            this.ColSaturation.DataPropertyName = "ColSaturation";
            ...
            // ColTxQueue
            // 
            this.ColTxQueue.DataPropertyName = "ColTxQueue";
            this.ColTxQueue.HeaderText = "TxQueue";
            this.ColTxQueue.Name = "ColTxQueue";
            this.ColTxQueue.ReadOnly = true;
            this.ColTxQueue.Width = 60;
            // 
            ...
            this.buttonBan.Location = new System.Drawing.Point(258, 237);
            ...
            this.buttonKick.Location = new System.Drawing.Point(339, 237);
            ...
            this.dataGridViewNetworkInfo.Size = new System.Drawing.Size(408, 257);
            ...
            this.colInNowDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle1;
            ...
            this.colIn10MinDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle2;
            ...
            this.colOutNowDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle3;
            ...
            this.colOut10MinDataGridViewTextBoxColumn.DefaultCellStyle = dataGridViewCellStyle4;
            ...
            // 
            this.dataGridViewTextBoxColumn3.DataPropertyName = "ColIP";
            ...
            // 
            this.dataGridViewTextBoxColumn4.DataPropertyName = "ColIP";
        ...
        private void timerStatus_Tick(object sender, EventArgs e)
        {
            ...
            // If the FLServer error screen is open then close it. Searching desktop windows is
            // expensive don't do it unless it is likely to have an error window open.
            if (!isConnected || flserverProcess==null || (flserverProcess != null && flserverProcess.HasExited))
            {
                ...
                foreach (KeyValuePair<IntPtr, string> window in desktopWindows)
                {
                    ...
                    {
                        AddLog("Closing server error window: " + window.Value);
                        _EndTask(window.Key, false, true);
                    }
                    else if (window.Value.Equals("FLServer.exe"))
                    {
                        AddLog("Closing server error window: " + window.Value);
                        _EndTask(window.Key, false, true);
                    }
                    else if (window.Value.Equals("Microsoft Windows"))
                    {
                        AddLog("Closing server error window: " + window.Value);
                        _EndTask(window.Key, false, true);
                    }
                    else if (window.Value.Equals("End Program - FLServer -"))
                    {
                        AddLog("Closing server error window: " + window.Value);
                        _EndTask(window.Key, true, true);
                    }
                    else if (window.Value.Equals("Freelancer"))
                    {
                        AddLog("Closing server error window: " + window.Value);
                        _EndTask(window.Key, false, true);
                    }
            ...
            if (pictureBoxStatus.Size.Width > 0)
            {
                maxStats = pictureBoxStatus.Size.Width * (int)AppSettings.Default.setGraphUpdateRate * 10;
                if (maxStats < 10000)
                    maxStats = 10000;
            }

            while (stats[StatsType.LOAD].Count > maxStats)
                stats[StatsType.LOAD].RemoveLast();
            while (stats[StatsType.MEMORY].Count > maxStats)
                stats[StatsType.MEMORY].RemoveLast();
            while (stats[StatsType.NPC_SPAWN].Count > maxStats)
                stats[StatsType.NPC_SPAWN].RemoveLast();
            while (stats[StatsType.PLAYERS].Count > maxStats)
            ...
            stats[StatsType.PLAYERS].AddFirst(new DataPoint(now.Ticks, players));
            ...
            labelStatusPlayers.Text = String.Format("Players\n{0}", players);
            labelStatusLoad.Text = String.Format("Load\n{0} ms", load);
            ...
            {
                if (lastFLHookReply.AddSeconds(60) > DateTime.Now)
                {
                    isConnected = true;
                    AddLog(String.Format("Server is not responding, waiting for response"));
                }
            }

            // Determine if the server is overloaded for longer than 60 seconds.
            ...
            switch (flServerState)
            {
                ...
                case FLSERVER_STATES.RUNNING:
                    ...
                    else
                    {
                        ...
                        if (!flserverProcess.HasExited)
                        {
                            try
                            {
                                flserverProcess.PriorityClass = ProcessPriorityClass.High;
                                if (AppSettings.Default.setAffinity != 0)
                                {
                                    Int64 procmask = (Int64)AppSettings.Default.setAffinity;
                                    flserverProcess.ProcessorAffinity = (IntPtr)procmask;
                                }
                            }
                            catch { }
                        }
        ...
        private void DrawGraph(Graphics g, Bitmap bm, float defaultMaxMagnitude, LinkedList<DataPoint> data, string type)
        {
            ...
            // Draw the graph based on load date until we either run out of data
            TimeSpan timeSpan = new TimeSpan(0, 0, (bm.Width - 60) * (int)AppSettings.Default.setGraphUpdateRate);
            long endTimeInTicks = DateTime.Now.Subtract(timeSpan).Ticks;
            ...
            lock (flHookPlayerInfoList)
            {
                ...
                foreach (KeyValuePair<int, FLHookSocket.PlayerInfo> kvp in flHookPlayerInfoList)
                {
                    ...
                    else
                    {
                        ...
                        row.ColLag = kvp.Value.lag;
                        row.ColLoss = kvp.Value.loss;
        ...
        private void UpdateUILogGameEvent(string msg)
        {
            ...
            if (oldText.Length > 20000)
                oldText = oldText.Substring(0, 20000);
